  ...
  return (
    <div className={cn('flex h-screen items-center justify-center')}>
      <div className={cn('flex flex-col items-center gap-16')}>
        <header className={cn('flex flex-col items-center gap-9')}>
          <h1
            className={cn(
              'leading text-2xl font-bold text-gray-800 dark:text-gray-100',
            )}
          >
            {t('index.title')} to <span className={cn('sr-only')}>Remix</span>
          </h1>
        </header>
        <nav
          className={cn(
        ...
        >
          <p className={cn('leading-6 text-gray-700 dark:text-gray-200')}>
            {t('index.whats-next')}
          </p>
          <ModeToggle />
          <LangToggle />
